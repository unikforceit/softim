 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme softim for publication on ThemeForest
...
add_action( 'tgmpa_register', 'softim_register_required_plugins' );
 ...
 */
function softim_register_required_plugins() {
