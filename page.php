...
$page_layout_meta = Softim_Group_Fields_Value::page_layout('softim');
$page_container_meta = Softim_Group_Fields_Value::page_container('softim','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area softim-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
